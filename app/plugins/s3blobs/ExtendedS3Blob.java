 ...
 * @author Pluce
 */
public class ExtendedS3Blob implements BinaryField, UserType {

	static String s3Bucket;
	static AmazonS3 s3Client;
        
        public static final String AWS_URL = "http://s3.amazonaws.com/";
        
	public String bucket;
	public String key;

	public ExtendedS3Blob() {
	}

	private ExtendedS3Blob(String bucket, String s3Key) {
		this.bucket = bucket;
		this.key = s3Key;
	}
        
        public String getUrl(){
            return AWS_URL + bucket + "/" + key;
        }
	...
	public Object nullSafeGet(ResultSet rs, String[] names, Object o) throws HibernateException, SQLException {
		...
		if (val == null || val.length() == 0 || !val.contains("|")) {
			return new ExtendedS3Blob();
		}
		return new ExtendedS3Blob(val.split("[|]")[0], val.split("[|]")[1]);
	}

	@Override
	public void nullSafeSet(PreparedStatement ps, Object o, int i) throws HibernateException, SQLException {
		if (o != null) {
			ps.setString(i, ((ExtendedS3Blob) o).bucket + "|" + ((ExtendedS3Blob) o).key);
		} else {
	...
	public Object deepCopy(Object o) throws HibernateException {
		...
		return new ExtendedS3Blob(this.bucket, this.key);
	}
